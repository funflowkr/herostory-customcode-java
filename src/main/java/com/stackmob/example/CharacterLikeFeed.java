...
public class CharacterLikeFeed implements CustomCodeMethod {

  @Override
  public String getMethodName() {
    return "character_like_feed";
  }
...
//  https://dev.twitter.com/docs/working-with-timelines
  ...
  public ResponseToProcess execute(ProcessedAPIRequest request, SDKServiceProvider serviceProvider) {
	...
	LoggerService logger = serviceProvider.getLoggerService(CharacterLikeFeed.class);
    ...
    query.add(new SMIn("likes", Arrays.asList(new SMString(characters_id))));
